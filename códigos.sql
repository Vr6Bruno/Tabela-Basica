...
COMMENT ON COLUMN produtos.imagem_arquivo                          IS                 'Arquivo no qua se encontra as imagens de cada produto.';
...
COMMENT ON COLUMN pedidos_itens.numero_da_linha                    IS                    'Númeração das linhas dos itens pedidos pelos clientes.';
...
-- Cria uma chave estrangeira na tabela pedidos_itens;
...
-- Cria uma chave estrangeira na coluna envio_id da tabela pedidos_itens;
